...
```{r}
training <- select(grants_2016, "action_date", "period_of_performance_start_date","period_of_performance_current_end_date", "cfda_title", "federal_action_obligation")
attach(training)       
...
plot(svm_model, training, period_of_performance_start_date~federal_action_obligation)
summary(svm_model)
```
